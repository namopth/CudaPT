#ifdef RT_XGEN
DEFINE_RT(PT Naive, cudaRTPT)
DEFINE_RT(PT NaiveRR, cudaRTPTRR)
DEFINE_RT(Regen, cudaRTPTRegen)
DEFINE_RT(PT SC, cudaRTPTStream)
DEFINE_RT(PT SC Regen, cudaRTPTStreamRegen)
DEFINE_RT(BDPT Regen, cudaRTBDPTRegen)
DEFINE_RT(BDPT SC, cudaRTBDPTStream)
DEFINE_RT(BDPT SC Bilaterial, cudaRTBDPTStreamBilat)
DEFINE_RT(BDPT SC Adap PDF, cudaRTBDPTStreamAdapPDF)
DEFINE_RT(BDPT SC Adap Cheat, cudaRTBDPTStreamAdapCheat)
DEFINE_RT(BDPT SC Adap Cheat Sort, cudaRTBDPTStreamAdapCheatSort)
DEFINE_RT(BDPT SC Adap Empirical, cudaRTBDPTStreamAdapEmp)
DEFINE_RT(BDPT SC Adap Bilat, cudaRTBDPTStreamAdapBilat)
DEFINE_RT(BDPT SC Adap Bilat Sort, cudaRTBDPTStreamAdapBilatSort)
